...
CREATE OR REPLACE NOTEBOOK IDENTIFIER('"DEMO_DB01"."{{env}}_SCHEMA"."{{env}}_06_load_excel_files"')
...
ALTER NOTEBOOK "DEMO_DB01"."{{env}}_SCHEMA"."{{env}}_06_load_excel_files" ADD LIVE VERSION FROM LAST;

CREATE OR REPLACE NOTEBOOK IDENTIFIER('"DEMO_DB01"."{{env}}_SCHEMA"."{{env}}_07_load_daily_city_metrics"')
...
ALTER NOTEBOOK "DEMO_DB01"."{{env}}_SCHEMA"."{{env}}_07_load_daily_city_metrics" ADD LIVE VERSION FROM LAST;
